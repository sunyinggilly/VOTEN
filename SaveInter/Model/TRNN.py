...
from SaveInter.Model.NNMain import NNMain
import numpy as np
...
class TRNN(NNMain):
    ...
    def _build_graph(self):
        ...
        deep_c, weights, loss_now = FPRC_transform(self.Xc, self.proj_layers, self.proj_res, self.n_cont, self.deep_layers[0],
                                                   activation=self.activation, l2_reg=self.l2_reg, last_act=self.last_act, name="FPRC_0")   # [-1, n_c, deep[0]]
        loss += loss_now
        self.weights.update(weights)
